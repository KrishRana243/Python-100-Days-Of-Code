...
print(f"\nThere are {len(all_links)} links to individual listings in total: \n")
print(all_links)
...
for n in range(len(all_links)):
    ...
    driver.get("https://docs.google.com/forms/d/e/1FAIpQLSezEolALmnSSWgD1WnBdvUOxMzdx030FbInb3_O-f3qGHKlQg/viewform?usp=header")
    time.sleep(2)
    ...
    next_form = driver.find_element(By.CSS_SELECTOR, value='.c2gzEf a')
